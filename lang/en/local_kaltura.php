...
$string['pluginname'] = 'Kaltura Media Local Libraries';
...
$string['conn_heading_desc'] = 'Input the type of connection you would like to use (Kaltura CE or the hosted Kaltura service) and enter in the credentials related to the connection you are using.';
...
$string['kaltura_player_resource_desc'] = 'Player used to play media for Media Resources.  This player will appear as the default player for new Media Resources. However it may be overridden if the <b>Override media resource player setting</b> is unchecked';
...
$string['media_converting'] = 'The media is still converting.  Please check the status of the media at a later time.';
$string['conn_failed_alt'] = 'The connection with Kaltura or Kaltura CE is currently unavailable.  Please inform your administrator.';
...
$string['video_valid_type'] = 'This file type is not supported.';
$string['video_too_large'] = 'The video you are trying to upload exceeds the maximum size of 2GB.';
$string['video_no_size'] = 'The file you are trying to upload is empty.';
$string['uploading_header'] = 'Uploading...';
$string['audio_settings'] = 'Microphone';
$string['video_settings'] = 'Camera';
$string['webcam_stop'] = 'Stop Recording';
$string['webcam_start'] = 'Start Recording';
$string['preview_start'] = 'Start Webcam';
$string['record_again'] = 'Record Again';
$string['not_allowed_hdr'] = 'Not Allowed';
$string['not_allowed'] = 'Your webcam/microphone could not be accessed. Ensure that this page has permission to access your webcam/microphone, and that your webcam/microphone are not being used by another application, then press "Start Webcam" to try again.';
$string['not_found_hdr'] = 'Webcam/Microphone Not Found';
$string['not_found'] = 'Ensure that your webcam and microphone are connected, then press "Start Webcam" to try again.';
$string['not_readable_hdr'] = 'Webcam/Microphone Not Readable';
$string['not_readable'] = 'Your webcam/microphone may be in use by another application. Ensure that your webcam and/or microphone are not already in use, then press "Start Webcam" to try again.';
$string['k_capture'] = 'Kaltura Capture';
$string['k_capture_title'] = 'Kaltura Capture Desktop Recorder';
$string['k_capture_lead'] = 'Kaltura Capture will launch automatically if you\'ve already installed it.';
