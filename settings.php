...
/**
 * Kaltura Local Libraries setting script
 *
...
if ($hassiteconfig) {
    ...
    $adminsetting = new admin_setting_configpasswordunmask('password',
                       get_string('hosted_password', 'local_kaltura'),
    ...
    $adminsetting = new admin_setting_configcheckbox('enable_webcam',
                                                     get_string('enable_webcam', 'local_kaltura'),
                                                     get_string('enable_webcam_desc', 'local_kaltura'), '0');
    $adminsetting->plugin = KALTURA_PLUGIN_NAME;
    $settings->add($adminsetting);
